...
namespace FullTimeAPI.Services
{
    public class SearchService : ISearchService
    {
        ...
        {
            var url = $"http://127.0.0.1:5001/home/search.html?partLeagueOrClubNameSearchFilter={Uri.EscapeDataString(team)}&clubSearchFilter=true";
        ...
        {
            var url = $"http://127.0.0.1:5001/home/club/{Uri.EscapeDataString(clubId)}.html";
            var response = await _httpClient.GetAsync(url);
            response.EnsureSuccessStatusCode();
        ...
        {
            var url = $"http://127.0.0.1:5001/home/search.html?partLeagueOrClubNameSearchFilter={Uri.EscapeDataString(team)}&clubSearchFilter=false";
            var response = await _httpClient.GetAsync(url);
            response.EnsureSuccessStatusCode();
        ...
        {
            var url = $"http://127.0.0.1:5001/index.html?league={Uri.EscapeDataString(leagueId)}";
            var response = await _httpClient.GetAsync(url);
            response.EnsureSuccessStatusCode();
