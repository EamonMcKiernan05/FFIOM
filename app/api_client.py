...
class FullTimeAPIClient:
    ...
    def __init__(self):
        ...
        # H2: TLS verification enabled (was disabled — MITM risk)
        # If the FullTime API uses a self-signed cert, set the CA bundle path
        # via the FULLTIME_CA_BUNDLE env var instead of disabling verification.
        ca_bundle = os.getenv("FULLTIME_CA_BUNDLE")
        if ca_bundle:
