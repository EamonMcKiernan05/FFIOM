...
def change_password(
    ...
    Password validation (min 10 chars, complexity) is enforced by the
    ChangePasswordRequest schema (H8).
    """
...
def link_email_password(
    ...
    Password validation enforced by LinkEmailPasswordRequest schema (H8).
    """
